<template>
  <div class="interaction-panel" v-reveal>
    <!-- Main Split Layout -->
    <div class="main-split-layout">
      ...
      <div class="left-panel report-style" ref="leftPanel">
        <div v-if="reportOutline" class="report-content-wrapper">
          ...
          <div class="report-header-block">
            ...
            <button class="chatgpt-toggle-btn" @click="showSidePanel = !showSidePanel">
              <svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2">
                <polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline>
              </svg>
              <span>{{ showSidePanel ? 'Hide Agent Interaction Tools' : 'Open Agent Interaction Tools' }}</span>
            </button>
          </div>
      ...
      <div class="right-panel" ref="rightPanel" v-show="showSidePanel">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">A quick-chat version of the report generation agent with 4 professional tools, live web research, Reddit field signals, and full Univerra memory</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Aligns local simulation evidence with fresh web-backed signals so the report stays grounded in current context instead of stale assumptions</div>
                  </div>
                </div>
