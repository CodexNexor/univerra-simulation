<template>
  <div class="process-page" v-reveal>
    <!-- Top navigation bar -->
    <nav class="navbar">
      <div class="nav-brand" @click="goHome">UNIVERRA</div>
    ...
    <div class="main-content">
      ...
      <div class="left-panel delay-100" :class="{ 'full-screen': isFullScreen }" v-reveal>
      ...
      <div class="right-panel delay-200" :class="{ 'hidden': isFullScreen }" v-reveal>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                <div class="detail-label">API Description</div>
                <div class="detail-content">
                  Based on the generated ontology, chunk documents and build the Univerra knowledge graph, extracting entities and relationships.
                </div>
              </div>
...
.left-panel.full-screen {
  /* No longer needed since it's always full screen technically, but we keep it to not break logic */
  width: 100vw !important;
}
...
/* Right panel - Floating Glass Panel overlays left panel */
.right-panel {
  position: absolute;
  top: 20px;
  right: 20px;
