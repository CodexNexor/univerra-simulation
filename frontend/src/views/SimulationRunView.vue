    ...
    <main class="content-area">
      ...
      <div class="panel-wrapper right" :style="rightPanelStyle">
        <Step3Simulation
          ...
          :maxRounds="maxRounds"
          :ensembleRunIndex="ensembleRunIndex"
...
const ensembleRunIndex = ref(route.query.ensembleRunIndex ? parseInt(route.query.ensembleRunIndex) : 0)
const scenarioVariant = ref(route.query.scenarioVariant || 'baseline_path')
...
onMounted(() => {
  ...
  addLog(`Ensemble seed variant: run ${ensembleRunIndex.value}, ${scenarioVariant.value}`)
