...
const handleNextStep = (params = {}) => {
  ...
  // Pass run controls via query params
  routeParams.query = {}
  if (params.maxRounds) {
    routeParams.query.maxRounds = params.maxRounds
  }
  if (params.ensembleRunIndex !== undefined) {
    routeParams.query.ensembleRunIndex = params.ensembleRunIndex
  }
  if (params.scenarioVariant) {
    routeParams.query.scenarioVariant = params.scenarioVariant
  }
