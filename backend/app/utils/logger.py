...
def _ensure_utf8_stdout():
    ...
    Fix Windows console character encoding issues
    """
...
def setup_logger(name: str = 'univerra', level: int = logging.DEBUG) -> logging.Logger:
    """
    Set up logger
...
def get_logger(name: str = 'univerra') -> logging.Logger:
    """
